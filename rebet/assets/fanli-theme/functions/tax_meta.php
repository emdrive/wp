...
if (is_admin()){
	...
	// $saved_data = get_tax_meta($term_id,'image_field_id',true); echo '<img src="'.$saved_data['src'].'">';

	// Use get_categories() to get categories $term_id, http://codex.wordpress.org/Function_Reference/get_categories
	// Use get_terms() to get taxonomies !Important! http://stackoverflow.com/questions/6272148/get-category-link-is-returning-nothing
}