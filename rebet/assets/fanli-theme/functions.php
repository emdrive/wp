...
// $wp_roles->roles['contributor']['name'] = '装修';
// $wp_roles->role_names['contributor'] = '装修';

// $wp_roles->roles['author']['name'] = '设计师';
// $wp_roles->role_names['author'] = '设计师';

// $wp_roles->roles['editor']['name'] = '家具';
// $wp_roles->role_names['editor'] = '家具';
