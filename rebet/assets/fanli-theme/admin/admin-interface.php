...
function optionsframework_add_admin() {
   ...
   $of_page = add_menu_page($themename, '网站设置', 'edit_theme_options', 'optionsframework','optionsframework_options_page','','3'); // Default
...
<div class="wrap" id="of_container">
  <div id="of-popup-save" class="of-save-popup">
    <div class="of-save-save">更新成功</div>
  </div>
  <div id="of-popup-reset" class="of-save-popup">
    <div class="of-save-reset">全部重置</div>
  </div>
  <form action="" enctype="multipart/form-data" id="ofform">
    ...
    <input type="submit" value="保存更新" class="button-primary" />
  </form>
  <form action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" method="post" style="display:inline" id="ofform-reset">
    <span class="submit-footer-reset">
    <input name="reset" type="submit" value="全部重置" class="button submit-button reset-button" onclick="return confirm('Click OK to reset. Any settings will be lost!');" />
...
function optionsframework_machine($options) {
	...
	foreach ($options as $value) {
		...
		case 'wysiwyg':
			...
			if( $std != "") $ta_value = stripslashes( $std );
			ob_start();
			wp_editor( $ta_value, $value['id'], array( 'textarea_name' => $value['id'] ) );
