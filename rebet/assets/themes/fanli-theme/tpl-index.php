                ...
                <div class="panel-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>1</td>
                            <td>本金 ( 初始金 )</td>
                            <td><span>￥</span><?php echo sprintf( "%.2f", $benjin_price ); ?></td>
                        ...
                        <tr>
                            <td>2</td>
                            <td>利息 ( 受益金 )</td>
                            <td><span>￥</span><?php echo sprintf( "%.2f", $lixi_price ); ?></td>
                            <td><a role="button" href="<?php echo get_permalink(30); ?>" class="btn btn-warning btn-sm">提现</a></td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>推荐奖 ( 奖金受益 )</td>
                            <td><span>￥</span><?php echo sprintf( "%.2f", $tuijian_price ); ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>领导奖 ( 晋级受益 )</td>
                            <td><span>￥</span><?php echo sprintf( "%.2f", $lingdao_price ); ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>5</td>
                            <td>积分受益</td>
                            <td><span>￥</span><?php echo sprintf( "%.2f", $jifen_price ); ?> </td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>6</td>
