...
if (is_home()||is_front_page()) {
    $hometitle        = get_post_meta($post->ID, "seo_title", true);
    if(empty($hometitle)){ $hometitle = $global_title; }

    $homeseo_desc     = get_post_meta($post->ID, "seo_desc", true);
    if(empty($homeseo_desc)){ $homeseo_desc = $global_desc; }
    
    $homeseo_keywords = get_post_meta($post->ID, "seo_keywords", true);
    if(empty($homeseo_keywords)){ $homeseo_keywords = $global_keywords; }
