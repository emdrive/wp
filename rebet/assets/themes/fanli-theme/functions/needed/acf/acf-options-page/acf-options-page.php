	...
	*/
	...
	function admin_menu() 
	{
		...
		if( $this->settings['show_parent'] )
		{
			...
			$parent_page = add_menu_page( $this->settings['title'], $this->settings['menu'], $this->settings['capability'], $this->settings['slug'], array($this, 'html'),'dashicons-admin-generic',2);
	...
	*/
	...
	{	
		...
		if( isset($_POST['acf_nonce']) && wp_verify_nonce($_POST['acf_nonce'], 'input') )
		{
			...
			$this->data['admin_message'] = __("数据更新",'acf');
		}
		...
		<div class="wrap no_move">
			...
			<div class="metabox-holder has-right-sidebar" id="poststuff">
				...
				<div class="inner-sidebar" id="side-info-column">
					...
					<!-- Update -->
					<div class="postbox">
						<h3 class="hndle"><span><?php _e("操作",'acf'); ?></span></h3>
						<div class="inside">
							...
							<input type="submit" class="acf-button" value="<?php _e("保存设置",'acf'); ?>" />
						</div>
					</div>
